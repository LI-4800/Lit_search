...
"""ASTM / ISO material-test-standards appraisal lens (STUB — Inkrement 6 skeleton).

Appraises material-property evidence against the ASTM International and ISO test standards applicable to the material under appraisal (e.g. ISO 10993 series for biocompatibility, ASTM F-series for medical materials). Optional override for ``BIOCHEMISTRY_MATERIAL_PROPERTY`` claims under formal standards governance.

NOT IMPLEMENTED:
    This is a registry-only stub. Both :meth:`AstmIsoMaterialLens.appraise` and
    :meth:`AstmIsoMaterialLens.render_summary` raise :class:`NotImplementedError`.
...
__all__ = ["AstmIsoMaterialLens"]


_NOT_IMPL_MSG = (
    "AstmIsoMaterialLens.{method} is not implemented — Inkrement-6 stub; "
    "full implementation scheduled for Stufe 1.10+."
)


@register_lens
class AstmIsoMaterialLens(AppraisalLens):
    """ASTM / ISO material-test-standards appraisal lens (STUB)."""

    name: ClassVar[str] = "astm_iso_material"

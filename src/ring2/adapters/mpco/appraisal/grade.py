...
"""GRADE quality-of-evidence appraisal lens (STUB — Inkrement 6 skeleton).

GRADE (Grading of Recommendations, Assessment, Development and Evaluations) rates the certainty of evidence per outcome across a body of studies into four tiers (high / moderate / low / very low). Optional override for ``CLINICAL_PERFORMANCE`` when a body-of-evidence judgement is preferred over per-study risk-of-bias.

NOT IMPLEMENTED:
    This is a registry-only stub. Both :meth:`GradeLens.appraise` and
    :meth:`GradeLens.render_summary` raise :class:`NotImplementedError`.
...
_NOT_IMPL_MSG = (
    "GradeLens.{method} is not implemented — Inkrement-6 stub; "
    "full implementation scheduled for Stufe 1.10+."
)


@register_lens
class GradeLens(AppraisalLens):
    """GRADE quality-of-evidence appraisal lens (STUB)."""

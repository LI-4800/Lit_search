...
"""ARRIVE 2.0 (in vivo animal-study reporting) appraisal lens (STUB — Inkrement 6 skeleton).

ARRIVE 2.0 (Animal Research: Reporting of In Vivo Experiments) is a reporting-quality checklist for in vivo animal studies. Optional override for ``BIOCHEMISTRY_MATERIAL_PROPERTY`` claims whose supporting evidence base is predominantly in vivo animal work.

NOT IMPLEMENTED:
    This is a registry-only stub. Both :meth:`ArriveLens.appraise` and
    :meth:`ArriveLens.render_summary` raise :class:`NotImplementedError`.
...
_NOT_IMPL_MSG = (
    "ArriveLens.{method} is not implemented — Inkrement-6 stub; "
    "full implementation scheduled for Stufe 1.10+."
)


@register_lens
class ArriveLens(AppraisalLens):
    """ARRIVE 2.0 (in vivo animal-study reporting) appraisal lens (STUB)."""

    name: ClassVar[str] = "arrive"
